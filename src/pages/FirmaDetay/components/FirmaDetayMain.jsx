        ...
        <main className="container">
            <div className="content-grid">
                <div className="main-info">
                    ...
                    <TendersSection tenders={fd.tenders} tendersLoading={fd.tendersLoading} isTendersTableMissing={fd.isTendersTableMissing} showAllTenders={fd.showAllTenders} onToggleAll={() => fd.setShowAllTenders(v => !v)} userProfile={fd.userProfile} firmaId={firmaId} firmaSlug={fd.firma?.slug} />
                </div>
                <aside className="sticky-sidebar">
                    <FavoritesCard firmaId={firmaId} firmaSlug={fd.firma?.slug} userProfile={fd.userProfile} isFavorited={fd.isFavorited} myLists={fd.myLists} selectedListId={fd.selectedListId} setSelectedListId={fd.setSelectedListId} isCreatingList={fd.isCreatingList} setIsCreatingList={fd.setIsCreatingList} newListName={fd.newListName} setNewListName={fd.setNewListName} isListCreating={fd.isListCreating} listDropdownOpen={fd.listDropdownOpen} setListDropdownOpen={fd.setListDropdownOpen} listDropdownRef={fd.listDropdownRef} toggleFavorite={fd.toggleFavorite} handleCreateList={fd.handleCreateList} handleListInputKeyDown={fd.handleListInputKeyDown} activeFavoriteListName={fd.activeFavoriteListName} />
                    <ContactCard firma={fd.firma} userProfile={fd.userProfile} isVerified={fd.isVerified} onQuoteRequest={() => fd.setShowQuoteModal(true)} googleMapsLink={fd.googleMapsLink} encodedAddress={fd.encodedAddress} adresText={fd.adresText} firmaId={firmaId} firmaSlug={fd.firma?.slug} />
                    <NotesCard firmaId={firmaId} firmaSlug={fd.firma?.slug} userProfile={fd.userProfile} noteTitle={fd.noteTitle} setNoteTitle={fd.setNoteTitle} noteText={fd.noteText} setNoteText={fd.setNoteText} savedNotes={fd.savedNotes} isNoteSaving={fd.isNoteSaving} editingNoteId={fd.editingNoteId} pendingDeleteNoteId={fd.pendingDeleteNoteId} setPendingDeleteNoteId={fd.setPendingDeleteNoteId} isNotesOpen={fd.isNotesOpen} setIsNotesOpen={fd.setIsNotesOpen} noteReminders={fd.noteReminders} getReminderForNote={fd.getReminderForNote} formatReminderLabel={fd.formatReminderLabel} reminderEnabled={fd.reminderEnabled} setReminderEnabled={fd.setReminderEnabled} reminderDate={fd.reminderDate} setReminderDate={fd.setReminderDate} reminderTime={fd.reminderTime} setReminderTime={fd.setReminderTime} reminderError={fd.reminderError} handleSaveNote={fd.handleSaveNote} handleEditNote={fd.handleEditNote} handleCancelNoteEditing={fd.handleCancelNoteEditing} handleDeleteNote={fd.handleDeleteNote} groupedSavedNotes={fd.groupedSavedNotes} orderedNoteGroups={fd.orderedNoteGroups} />
                </aside>
            </div>
        </main>
    </div>
