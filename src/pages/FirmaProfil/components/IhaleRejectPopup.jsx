...
const IhaleRejectPopup = ({ rejectNoteState, setRejectNoteState, onConfirmReject }) => {
    ...
    return (
        <div className="tom-contact-overlay" onClick={onClose}>
            ...
            <div className="tom-reject-note-card" role="dialog" aria-modal="true" aria-labelledby="reject-popup-title" onClick={e => e.stopPropagation()}>
                <button className="tom-contact-card__close" onClick={onClose} aria-label="Kapat"><span className="material-symbols-outlined">close</span></button>
                <div className="tom-scoring-info-card__icon" style={{ background: 'linear-gradient(135deg, #ef4444, #dc2626)' }}>
                    <span className="material-symbols-outlined">cancel</span>
                </div>
                <h3 id="reject-popup-title">Teklifi Reddet</h3>
