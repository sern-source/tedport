                      ...
                      <div className="act-qa-top">
                        ...
                        <div className="act-qa-actions">
                          <button
                            ...
                            data-tooltip={qa.is_active ? 'Pasife Al' : 'Aktife Al'}
                          >
                            <span className="material-symbols-outlined">
                              {qa.is_active ? 'toggle_on' : 'toggle_off'}
                            </span>
                          </button>
                          <button className="act-icon-btn act-icon-btn--edit" onClick={() => openQaForm(qa)} data-tooltip="Düzenle">
                            <span className="material-symbols-outlined">edit</span>
                          </button>
                          <button className="act-icon-btn act-icon-btn--delete" onClick={() => confirmDelete('qa', qa.id)} data-tooltip="Sil">
                    ...
                    <div key={qq.id} className={`act-qq-card ${!qq.is_active ? 'act-qq-card--inactive' : ''}`}>
                      ...
                      <div className="act-qq-actions">
                        <button
                          ...
                          data-tooltip={qq.is_active ? 'Pasife Al' : 'Aktife Al'}
                        >
                          <span className="material-symbols-outlined">
                            {qq.is_active ? 'toggle_on' : 'toggle_off'}
                          </span>
                        </button>
                        <button className="act-icon-btn act-icon-btn--edit" onClick={() => openQqForm(qq)} data-tooltip="Düzenle">
                          <span className="material-symbols-outlined">edit</span>
                        </button>
                        <button className="act-icon-btn act-icon-btn--delete" onClick={() => confirmDelete('qq', qq.id)} data-tooltip="Sil">
                          <span className="material-symbols-outlined">delete</span>
                        </button>
                      </div>
                    </div>
