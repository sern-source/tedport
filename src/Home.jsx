    ...
    return (
        <div className="supplier-connect-wrapper">
            ...
            <main>
                ...
                {/* Enes Doğanay | 15 Nisan 2026: Mobil uygulama yakında bilgilendirme banner'ı */}
                    ...
                    <div className="container">
                        <div className="sc-app-banner-inner">
                            ...
                            <div className="sc-app-banner-content">
                                <div className="sc-app-banner-badge">Yakında</div>
                                <h3>Tedport Mobil Uygulama Yolda!</h3>
                                <p>Tedarikçilerinizi artık cebinizden yönetin. iOS ve Android için mobil uygulamamız çok yakında hizmetinize sunulacak.</p>
                            </div>
                            <div className="sc-app-banner-stores">
                                <div className="sc-store-btn">
                                    ...
                                    <div>
                                        <span className="sc-store-label">Çok Yakında</span>
                                        <span className="sc-store-name">App Store</span>
                                    </div>
                                </div>
                                <div className="sc-store-btn">
                                    <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M3.18 23.67c-.38-.21-.68-.62-.68-1.15V1.48C2.5.82 2.93.36 3.46.23l10.08 11.3L3.18 23.67zm1.47-23L16.23 9.4l-2.73 3.07L4.65.66zm13.72 10.42l2.88 1.66c.53.31.53.81 0 1.12l-2.88 1.66-3.1-3.47 3.1-2.97zM4.65 23.34l8.85-8.81 2.73 3.07L4.65 23.34z"/></svg>
                                    <div>
                                        <span className="sc-store-label">Çok Yakında</span>
            ...
            {/* Enes Doğanay | 15 Nisan 2026: Eski footer kaldırıldı, SharedFooter entegre edildi */}
            <SharedFooter />
        </div>
    );
};
